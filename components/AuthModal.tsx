    ...
    try {
      ...
      if (error) {
        ...
        if (
          ...
          error.message?.toLowerCase().includes('not_enabled') ||
          error.message?.toLowerCase().includes('unsupported') ||
          error.message?.toLowerCase().includes('validation_failed')
        ) {
          msg = provider === 'apple'
            ? 'Apple Sign In is currently unavailable. Please use Google or email.'
              ...
              <div className="md:col-span-7 flex flex-col justify-center space-y-3">
                ...
                <div className="flex gap-2.5">
                  ...
                  <button
                    ...
                    type="button"
                    className="flex-1 border border-[#D5D3CC] bg-white hover:border-[#111111] py-2.5 rounded-lg flex items-center justify-center gap-2 text-xs font-inter text-[#333333] hover:text-[#111111] transition-all cursor-pointer shadow-xs min-h-[40px] disabled:opacity-60"
                  >
